...
import com.liferay.docs.infos.model.DistrictModel;
import com.liferay.docs.infos.model.DistrictSoap;
...
/**
 * The base model implementation for the District service. Represents a row in the &quot;infos_District&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.docs.infos.model.DistrictModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DistrictImpl}.
 * </p>
 *
 * @author Joe Bloggs
 * @see DistrictImpl
 * @see com.liferay.docs.infos.model.District
 * @see com.liferay.docs.infos.model.DistrictModel
 * @generated
 */
@JSON(strict = true)
public class DistrictModelImpl extends BaseModelImpl<District>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a district model instance should use the {@link com.liferay.docs.infos.model.District} interface instead.
     */
    public static final String TABLE_NAME = "infos_District";
    ...
    public static final String TABLE_SQL_CREATE = "create table infos_District (districtId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,code_ INTEGER,isArchived BOOLEAN)";
    public static final String TABLE_SQL_DROP = "drop table infos_District";
    public static final String ORDER_BY_JPQL = " ORDER BY district.name ASC";
    public static final String ORDER_BY_SQL = " ORDER BY infos_District.name ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.liferay.docs.infos.model.District"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.liferay.docs.infos.model.District"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.liferay.docs.infos.model.District"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.liferay.docs.infos.model.District"));
    ...
    public void resetOriginalValues() {
        ...
        districtModelImpl._originalGroupId = districtModelImpl._groupId;

        districtModelImpl._setOriginalGroupId = false;
